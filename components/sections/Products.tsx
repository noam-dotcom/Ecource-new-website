                ...
                {img && (
                  <div className="relative w-full h-56 overflow-hidden">
                    <Image
                      ...
                      alt={prod.category}
                      fill
                      className={`group-hover:scale-105 transition-transform duration-500 ${idx === 5 ? "object-contain object-center" : "object-cover object-center"} ${idx === 6 ? "scale-150" : ""} ${idx === 2 ? "scale-125" : ""} ${idx === 4 ? "brightness-125" : ""}`}
