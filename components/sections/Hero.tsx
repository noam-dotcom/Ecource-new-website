    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 animate-fade-in">
          {[
            { value: "$130B+/Year", label: "Untapped Seafood Market", sub: "~65MT/Year underutilized fish biomass · FAO SOFIA 2024" },
            { value: "60MT/Year", label: "Fin Fish Biomass Wasted Annually", sub: "Discarded by conventional processing" },
        ...
        <div className="mt-6 flex justify-center animate-fade-in">
          <div className="inline-flex items-center gap-2 bg-gold-500/10 border border-gold-500/40 text-white text-sm font-semibold px-6 py-3 rounded-full">
            ...
            Patent-Pending Technology · Applied in 32 Countries
          </div>
        </div>
