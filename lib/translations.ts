...
export const translations = {
  en: {
    ...
    hero: {
      ...
      stat1Value: "$0",
      stat1Label: "Added Input Cost for 2× Revenue Output",
      stat2Value: "733M",
      stat2Label: "People Facing Chronic Hunger Today",
      stat3Value: "9.7B",
      stat3Label: "Projected World Population by 2050",
    },
    problem: {
      label: "The Problem",
  ...
  he: {
    ...
    hero: {
      ...
      stat1Value: "$0",
      stat1Label: "עלות חומרי גלם נוספת לכפל ההכנסות",
      stat2Value: "733M",
      stat2Label: "אנשים הסובלים מרעב כרוני כיום",
      stat3Value: "9.7B",
      stat3Label: "אוכלוסיית העולם הצפויה עד 2050",
    },
    problem: {
      label: "הבעיה",
  ...
  zh: {
    ...
    hero: {
      ...
      cta2: "了解技术",
      stat1Value: "$0",
      stat1Label: "额外原料成本即可实现双倍收益",
      stat2Value: "7.33亿",
      stat2Label: "当今面临慢性饥饿的人口",
      stat3Value: "97亿",
      stat3Label: "2050年全球人口预测",
    },
    problem: {
      label: "问题",
      headline: "全球渔业",
  ...
  es: {
    ...
    hero: {
      ...
      stat1Value: "$0",
      stat1Label: "Costo de Insumo Adicional para Duplicar Ingresos",
      stat2Value: "733M",
      stat2Label: "Personas con Hambre Crónica Hoy",
      stat3Value: "9.7B",
      stat3Label: "Población Mundial Proyectada para 2050",
    },
    problem: {
      label: "El Problema",
  ...
  fr: {
    ...
    hero: {
      ...
      stat1Value: "$0",
      stat1Label: "Coût d'Intrant Supplémentaire pour Doubler les Revenus",
      stat2Value: "733M",
      stat2Label: "Personnes en Situation de Faim Chronique",
      stat3Value: "9,7Md",
      stat3Label: "Population Mondiale Projetée d'ici 2050",
    },
    problem: {
      label: "Le Problème",
