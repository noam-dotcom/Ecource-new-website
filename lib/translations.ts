...
export const translations = {
  en: {
    ...
    sdg: {
      ...
      description: "Ecource's breakthrough technology directly advances 5 of the 17 UN SDGs — delivering measurable impact for global food security, ocean health, and responsible industrial production.",
      ...
      goals: [
        ...
        { id: 12, title: "Responsible Consumption & Production", tagline: "Near-zero biomass waste — every part of every fish becomes premium human-grade food" },
  ...
  he: {
    ...
    sdg: {
      ...
      description: "הטכנולוגיה של Ecource מקדמת ישירות 5 מתוך 17 יעדי ה-SDG של האו\"ם — ומספקת השפעה מדידה על ביטחון תזונתי עולמי, בריאות האוקיינוסים וייצור תעשייתי אחראי.",
  ...
  zh: {
    ...
    sdg: {
      ...
      description: "Ecource的突破性技术直接推动17个联合国可持续发展目标中的5个——为全球粮食安全、海洋健康和负责任工业生产带来可衡量的影响。",
  ...
  es: {
    ...
    sdg: {
      ...
      description: "La tecnología revolucionaria de Ecource impulsa directamente 5 de los 17 ODS de la ONU — generando impacto medible en la seguridad alimentaria global, la salud de los océanos y la producción industrial responsable.",
  ...
  fr: {
    ...
    sdg: {
      ...
      description: "La technologie révolutionnaire d'Ecource fait directement progresser 5 des 17 ODD de l'ONU — générant un impact mesurable sur la sécurité alimentaire mondiale, la santé des océans et la production industrielle responsable.",
